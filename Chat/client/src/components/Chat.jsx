                ...
                <div className="bg-white w-1/4 pl-4 pt-4">
                    ...
                    {Object.keys(peopleOnline).map(userId => (
                        <div
                            ...
                            key={userId}
                        >
                            <Avatar userId={userId} username={peopleOnline[userId].split('')[0].toUpperCase() + peopleOnline[userId].slice(1).split('').join('')} />
                            <span className="text-gray-800">{peopleOnline[userId].split('')[0].toUpperCase() + peopleOnline[userId].slice(1).split('').join('')}</span>
                        </div>
                    ))}
                </div>
