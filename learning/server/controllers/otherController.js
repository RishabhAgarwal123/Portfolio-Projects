...
export const getAdminDashboardDetails = catchAsyncError(async (req, res, next) => {
    ...
    let usersIncreased = true;
    let subscriptionIncreased = true;
    let viewsIncreased = true;
    ...
    if (statsData[10].views === 0) viewsPercentage = viewsCount * 100;
        ...
        if (subscriptionPercentage < 0) subscriptionIncreased = false;
        if (usersPercentage < 0) usersIncreased = false;
